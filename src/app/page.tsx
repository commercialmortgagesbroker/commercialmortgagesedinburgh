...
export const metadata: Metadata = {
  title: `Commercial Mortgages Edinburgh | Scottish Capital Commercial Mortgage Broker`,
  description:
    "Commercial mortgages Edinburgh: specialist commercial mortgage broker for the Scottish capital. Financial-services office investment at Edinburgh Park and Lothian Road, life-sciences and laboratory at the Edinburgh BioQuarter, St James Quarter retail, Royal Mile and New Town hospitality, Marchmont and Newington student HMO portfolio refinance. 90+ lender panel, 6.0 to 9.0% pa mid-2026, 75% max LTV. Scottish law: standard security, Land Register of Scotland, LBTT. Indicative terms in 48 hours.",
  keywords: [
    kw,
    "commercial mortgage broker edinburgh",
    "edinburgh commercial mortgages",
    "edinburgh commercial property finance",
    "edinburgh commercial investment mortgage",
    "edinburgh owner-occupier mortgage",
    "edinburgh semi-commercial mortgage",
    "edinburgh hotel mortgage",
    "edinburgh hmo portfolio mortgage",
    "edinburgh life sciences mortgage",
    ...
    "marchmont hmo mortgage edinburgh",
    "royal mile hotel mortgage edinburgh",
    `commercial mortgages ${loc}`,
  ],
