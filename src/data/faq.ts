...
export const faqItems: FAQItem[] = [
  ...
  {
    question: "How long does it take to arrange a Edinburgh commercial mortgage?",
  ...
  {
    question: "Which Edinburgh areas do you cover?",
    slug: "which-areas-do-you-cover",
    answer: `We arrange commercial mortgages across the full Edinburgh metropolitan district and the wider the Lothians footprint. Twelve area pages cover the active commercial sub-markets: Old Town and Royal Mile (EH1/EH2 CBD office, retail, mixed-use), New Town and George Street (regeneration, mixed-use refinance), West End and Haymarket (Urban Village creative offices, listed mill stock), Princes Street and St James (Dalkeith Road semi-commercial, HMO, leisure), Leith and Newhaven (EH6 HMO concentration), Tollcross and Fountainbridge (retail park, Tollcross and Fountainbridge Road industrial), Southside and the Meadows (EH7 independent retail and dental cluster), Morningside and Bruntsfield (premium care home cluster, Hanover Street retail), Stockbridge (George Street independent retail and professional services), Portobello (South Edinburgh light industrial, Class E leisure), Edinburgh Park and South Gyle (EH12 secondary retail and mixed-use), Edinburgh BioQuarter and Little France (Sighthill industrial, Queen Street retail). Beyond Edinburgh itself we routinely fund deals in Glasgow, Livingston, Falkirk, Linlithgow, Penicuik, Dalkeith, Corstorphine and the wider Scotland commuter belt from the same Edinburgh-based lender panel.`,
    relatedLinks: [
