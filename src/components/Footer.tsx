    ...
    <footer className="bg-primary text-gray-300">
      <div className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-gray-400">
              ...
              owner-occupier businesses and trading operators across Edinburgh
              and the Lothians. We arrange owner-occupier, investment,
        ...
        <div className="mt-8 border-t border-white/10 pt-8 text-center text-xs text-gray-500">
          ...
          <p className="mt-2">
            {SITE_NAME} is a trading name of Lenzie Consulting Ltd.
